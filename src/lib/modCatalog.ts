...
export const MOD_CATALOG = [
  { id: "bidkv", name: "BidKV", kind: "推理扩展", description: "KV 压力下的效用感知抢占策略。", repository: "https://github.com/vLLM-HUST/vllm-hust-bidkv", sha: "5b114caa35537ff0e1bbd1a2ea604cbb9eb95497", candidateSha: "5fb109be683f486dfdf45d50f88c6138e003637e", candidateManagerSha: MOD_MANAGER_CANDIDATE_SHA, candidateStatus: "current-main-tp4-graph-qualification-failed", qualifiedModels: [], bundle: "org.vllm-hust.bidkv", package: "bidkv", compatibility: "Qwen3.8-27B：Core a4d6aa02 · Ascend 2c8c7221 · TP4 graph · 验收未通过", requirements: "真实 A/B 中 BidKV 抢占 164 次（内置策略 161 次）、吞吐下降 2.35%、P95 TTFT 上升 2.15%，且长输出哈希未匹配；修复并重新验收前禁止启用。" },
